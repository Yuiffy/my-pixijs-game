...
export const UNIT_DEFS: Record<UnitId, UnitDefinition> = {
  ...
  mitsuri: unit({
    ...
    tier: 3,
    cost: 3,
    traits: ["yue_gang", "mystic", "finance"],
    hp: 188,
    attack: 27,
    armor: 11,
    range: 225,
  ...
  nori: unit({
    ...
    traits: ["ranger", "host", "vanguard", "traffic"], hp: 138, attack: 23, armor: 7, range: 225, attackInterval: 1.02, moveSpeed: 56,
  ...
  mumu: unit({
    ...
    traits: ["vanguard", "dance", "traffic"], hp: 330, attack: 34, armor: 29, range: 52, attackInterval: 0.96, moveSpeed: 68,
  ...
  rei: unit({
    ...
    traits: ["mystic", "ranger", "traffic"], hp: 270, attack: 43, armor: 18, range: 230, attackInterval: 0.82, moveSpeed: 66,
