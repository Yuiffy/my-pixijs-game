...
export const TRAITS: Record<TraitId, TraitDefinition> = {
  ...
  vanguard: { id: "vanguard", name: "怕死", family: "职业", color: "#819eff", thresholds: [2, 4, 6], description: "怕死位最懂得保全自己；受击会跳开，但会优先留在自己的攻击距离内，无法后撤时改为侧跳。", bonuses: ["怕死单位 +12% 最大生命、+8 护甲；受击后短距离后跳", "怕死单位 +25% 最大生命、+18 护甲；受击后跳更远；所有近战友军 +8% 最大生命、+6 护甲", "怕死单位 +42% 最大生命、+32 护甲；受击后跳最远；所有近战友军 +16% 最大生命、+12 护甲"] },
