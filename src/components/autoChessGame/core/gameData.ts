...
export const TRAITS: Record<TraitId, TraitDefinition> = {
  ...
  vanguard: { id: "vanguard", name: "护航", family: "职业", color: "#819eff", thresholds: [2, 4, 6], description: "护航位永远站在最前面，先把伤害接下来。", bonuses: ["护航单位 +12% 生命、+8 护甲", "护航 +25%/+18；所有近战友军 +8% 生命、+6 护甲", "护航 +42%/+32；所有近战友军 +16% 生命、+12 护甲"] },
  ranger: { id: "ranger", name: "切片", family: "职业", color: "#f2d15e", thresholds: [2, 4, 6], description: "切片手一旦找到高光时刻，就会连续输出。", bonuses: ["切片单位 +12% 攻速", "切片 +26%；所有远程友军 +15% 攻速", "切片 +45%；所有远程友军 +30% 攻速"] },
  ...
  chuanmei: {
    ...
    bonuses: ["川妹成员普攻与技能附加辣味灼烧", "灼烧增强；全体远程友军普攻附带较弱辣味灼烧"],
  },
  gluttony: {
    id: "gluttony",
    name: "贪吃",
  ...
  sui_shiori: {
    ...
    color: "#f0aee7",
    thresholds: [2, 4, 6],
    description: "必须同时有岁己与栞栞在场；任一人施法都会呼叫另一人补一发弹幕。",
    bonuses: ["岁己与栞栞施法后触发 65% 攻击力协战弹幕", "协战弹幕提升至 85%，共享冷却缩短", "协战弹幕提升至 110%，共享冷却大幅缩短"],
  },
};
...
export const UNIT_DEFS: Record<UnitId, UnitDefinition> = {
  ...
  sui: unit({
    ...
    tier: 1,
    cost: 1,
    traits: ["sui_forms", "vanguard", "gluttony", "skeleton_soldier", "sui_shiori"],
    hp: 244,
    attack: 17,
    armor: 24,
    range: 48,
  ...
  sui_blue: unit({
    ...
    tier: 2,
    cost: 2,
    traits: ["sui_forms", "ranger", "skeleton_soldier", "sui_shiori"],
    hp: 148,
    attack: 25,
    armor: 8,
    range: 235,
  ...
  shiori: unit({
    ...
    tier: 2,
    cost: 2,
    traits: ["aegis", "mystic", "skeleton_soldier", "sui_shiori", "yue_gang"],
    hp: 164,
    attack: 20,
    armor: 11,
    range: 205,
  ...
  void_oracle: unit({
    ...
    tier: 3,
    cost: 3,
    traits: ["rift", "mystic", "gluttony", "gen27", "yue_gang"],
    hp: 172,
    attack: 25,
    armor: 10,
    range: 215,
  ...
  sui_flower: unit({
    ...
    tier: 3,
    cost: 3,
    traits: ["sui_forms", "mystic", "chuanmei", "sui_shiori"],
    hp: 184,
    attack: 27,
    armor: 12,
    range: 205,
  ...
  sun_phoenix: unit({
    ...
    tier: 4,
    cost: 4,
    traits: ["ember", "ranger", "gluttony", "chuanmei"],
    hp: 190,
    attack: 31,
    armor: 12,
    range: 225,
  ...
  prism_sage: unit({
    ...
    tier: 4,
    cost: 4,
    traits: ["aegis", "mystic", "sui_shiori", "yue_gang"],
    hp: 205,
    attack: 25,
    armor: 18,
    range: 210,
  ...
  biscuit_sui: unit({
    ...
    tier: 5,
    cost: 5,
    traits: ["sui_forms", "brawler", "chuanmei"],
    hp: 420,
    attack: 44,
    armor: 34,
    range: 58,
...
export const STARTERS: StarterDefinition[] = [
  ...
  },
  {
    ...
    description: "携带浣熊切片开局；毛茸茸吸血额外 +6%，初始金币 +1。",
    unit: "gale_archer",
    color: "#76e7ae",
  },
];
...
export const WAVES: WaveDefinition[] = [
  ...
  },
  {
    ...
    name: "毛茸茸联动",
    tag: "normal",
    description: "绒绒护航保护浣熊切片，优先处理后排输出。",
    modifier: 0.75,
  ...
  },
  {
    ...
    name: "毛茸茸团建",
    tag: "normal",
    description: "海盐急救与绒绒旋风续航很强，需要集火或切后。",
    modifier: 1,
    units: [
      { id: "thorn_brute" },
      { id: "mossback" },
