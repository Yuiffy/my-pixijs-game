...
export const TRAITS: Record<TraitId, TraitDefinition> = {
  ...
  vanguard: { id: "vanguard", name: "怕死", family: "职业", color: "#819eff", thresholds: [2, 4, 6], description: "怕死所以不敢贴脸：攻击距离更远，被打到还会往后弹开。", bonuses: ["怕死单位攻击距离 +36；受击时小幅后撤", "怕死单位攻击距离 +56；受击后撤增强；全体友军 +10% 最大生命", "怕死单位攻击距离 +80；受击后撤更远；全体友军 +18% 最大生命"] },
