...
export const UNIT_DEFS: Record<UnitId, UnitDefinition> = {
  ...
  dawn_duelist: unit({
    ...
    moveSpeed: 82,
    abilityName: "迎客松·大吧唧",
    abilityDescription: "随机使出一种怪话：迎客松短暂嘲讽附近敌人并降低 20% 移速；75mm 大吧唧造成范围伤害与短暂眩晕。",
...
attackInterval: 0.86,
    moveSpeed: 68,
    abilityName: "涅槃重生",
abilityDescription: "初始以近战形态作战；首次倒下或开战 4 秒后主动涅槃，清除负面状态并重生为低生命远程形态。重生后 1 秒免疫伤害且不易被敌人选中，4 秒内普攻会后退但不会退出当前攻击距离。",
