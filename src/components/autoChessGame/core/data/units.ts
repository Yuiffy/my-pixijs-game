...
shop: true,
  ...
  komichi: unit({
    ...
    abilityRange: 420,
    abilityName: "都市传说降临",
    abilityDescription: "能量满时持路牌发动【出道冲击】，高速贴近并撞飞沿途敌人、击晕目标。持牌期间能量持续下降，普攻砸下路牌；攻击、受击与自动回能可延长状态，再次回满会再次冲击。",
    passiveName: "路牌格挡",
    passiveDescription: "受到远程来源伤害时有概率举牌格挡，减伤并回复能量、短暂加速；【都市传说降临】期间触发概率提高。",
    abilityLevels: [
      { summary: "格挡 42% / 72% · 射程 +105", description: "路牌格挡基础 / 持牌触发率为 42% / 72%，减免 36% 远程伤害，回复 12 能量并短暂加速。持牌普攻击退 20，出道冲击眩晕 0.65 秒。", stats: { duration: 5.5, rangeBonus: 105, knockback: 20, rangedReduction: 0.36, blockChance: 0.42, activeBlockChance: 0.72, blockEnergy: 12, moveSpeedBonus: 46, moveSpeedDuration: 1.1, impactStun: 0.65 } },
      { summary: "格挡 46% / 78% · 射程 +120", description: "路牌格挡基础 / 持牌触发率为 46% / 78%，减免 42% 远程伤害，回复 15 能量并短暂加速。持牌普攻击退 26，出道冲击眩晕 0.8 秒。", stats: { duration: 6.25, rangeBonus: 120, knockback: 26, rangedReduction: 0.42, blockChance: 0.46, activeBlockChance: 0.78, blockEnergy: 15, moveSpeedBonus: 54, moveSpeedDuration: 1.1, impactStun: 0.8 } },
      { summary: "格挡 50% / 84% · 射程 +140", description: "路牌格挡基础 / 持牌触发率为 50% / 84%，减免 48% 远程伤害，回复 18 能量并短暂加速。持牌普攻击退 34，出道冲击眩晕 0.95 秒。", stats: { duration: 7, rangeBonus: 140, knockback: 34, rangedReduction: 0.48, blockChance: 0.5, activeBlockChance: 0.84, blockEnergy: 18, moveSpeedBonus: 62, moveSpeedDuration: 1.1, impactStun: 0.95 } },
    ],
