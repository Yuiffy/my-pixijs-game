import { ENERGY_PROFILES, HAREI_TRICK_ENERGY_PROFILE, LIAN_FINALE_ENERGY_PROFILE, REI_SLOW_ENERGY_PROFILE, RIFT_STALKER_OFFENSE_ENERGY_PROFILE, SHOP_UNIT_IDS, ShopUnitId, UnitDefinition, UnitId, WARM_SUPPORT_ENERGY_PROFILE, YUKISYO_EARLY_SHIELD_ENERGY_PROFILE, ZEYIN_REBIRTH_ENERGY_PROFILE } from "./types";
...
> = {
  ...
  komichi: { attackType: "melee", energyProfile: ENERGY_PROFILES.assault, range: 58, moveSpeed: 74, abilityCastTiming: "offenseInRange" },
...
export const UNIT_DEFS: Record<UnitId, UnitDefinition> = {
  ...
  mitsuri: unit({
    ...
    abilityRange: 320,
    abilityName: "脚臭试管",
    abilityDescription: "向敌人最密集处丢出 🧪 试管，落地形成一滩持续区域；踩入其中的敌人会陷入恐惧，停止攻击并主动远离。",
    abilityLevels: [
      { summary: "118 范围 · 4.2 秒", description: "向敌人最密集处丢出 🧪 试管，落地形成半径 118、持续 4.2 秒的脚臭区域；踩入其中的敌人会陷入恐惧，停止攻击并主动远离。", stats: { radius: 118, duration: 4.2 } },
      { summary: "134 范围 · 4.8 秒", description: "向敌人最密集处丢出 🧪 试管，落地形成半径 134、持续 4.8 秒的脚臭区域；踩入其中的敌人会陷入恐惧，停止攻击并主动远离。", stats: { radius: 134, duration: 4.8 } },
      { summary: "152 范围 · 5.4 秒", description: "向敌人最密集处丢出 🧪 试管，落地形成半径 152、持续 5.4 秒的脚臭区域；踩入其中的敌人会陷入恐惧，停止攻击并主动远离。", stats: { radius: 152, duration: 5.4 } },
    ],
...
shop: true,
  ...
  komichi: unit({
    ...
    moveSpeed: 74,
    abilityName: "路牌开道",
    abilityDescription: "需要接近敌人才能发动；摘下围巾并掏出路牌，持续期间增加攻击距离，普攻小幅击退目标，且用路牌格挡一部分远程来源伤害。",
    abilityLevels: [
      { summary: "5.5 秒 · 射程 +105", description: "掏出路牌持续 5.5 秒，攻击距离 +105；普攻击退目标 28 距离，并格挡 28% 的远程来源伤害。", stats: { duration: 5.5, rangeBonus: 105, knockback: 28, rangedReduction: 0.28 } },
      { summary: "6.25 秒 · 射程 +120", description: "掏出路牌持续 6.25 秒，攻击距离 +120；普攻击退目标 36 距离，并格挡 35% 的远程来源伤害。", stats: { duration: 6.25, rangeBonus: 120, knockback: 36, rangedReduction: 0.35 } },
      { summary: "7 秒 · 射程 +140", description: "掏出路牌持续 7 秒，攻击距离 +140；普攻击退目标 44 距离，并格挡 42% 的远程来源伤害。", stats: { duration: 7, rangeBonus: 140, knockback: 44, rangedReduction: 0.42 } },
    ],
