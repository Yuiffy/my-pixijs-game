...
abilityDescription: "发射 8 枚低伤害苹果派子弹。",
    portrait: "/images/livers/nori.jpg",
portraitFocus: "top",
shop: true,
  }),
  meme: unit({
...
abilityDescription: "震晕附近敌人并造成伤害，随后按造成伤害回复自身生命。",
    portrait: "/images/livers/meme.jpg",
portraitFocus: "top",
shop: true,
  }),
  zeyin: unit({
...
abilityDescription: "首命以低生命近战形态自动积蓄能量，首次倒下或能量充满时涅槃，清除负面状态并以更高生命重生为远程形态。重生后继续自动回能，满能量发射一枚带灼烧的 🔥 火球；前 4 秒普攻会后退，但不会退出当前攻击距离。",
    ...
    portrait: "/images/livers/zeyin.jpg",
portraitFocus: "top",
shop: true,
  }),
  kioi: unit({
...
abilityDescription: "点名一名敌人，造成伤害并降低其攻击力与护甲。",
    portrait: "/images/livers/kioi.jpg",
portraitFocus: "top",
shop: true,
  }),
  nightin: unit({
...
abilityDescription: "向自身周围抛落数颗棒棒糖；糖果会留在地上，友军踩到会回复生命并加速，敌人踩到会受伤并减速。",
    portrait: "/images/livers/tiandou.jpg",
portraitFocus: "top",
shop: true,
  }),
  youyi: unit({
...
abilityDescription: "跃向最远敌人，连续踢击两次并短暂眩晕。",
    portrait: "/images/livers/youyi.jpg",
portraitFocus: "top",
shop: true,
  }),
  akirinco: unit({
...
abilityDescription: "跃至生命最低的敌人身边连续斩击；完成击杀后恢复生命。",
    portrait: "/images/livers/akirinco.jpg",
portraitFocus: "top",
shop: true,
  }),
  lovely: unit({
...
abilityDescription: "需要接近敌人才能发动；持续捏住最近的一名敌人，双方都无法行动，期间持续造成伤害，并将伤害的大部分转化为自身生命。",
    portrait: "/images/livers/lovely.webp",
portraitFocus: "top",
shop: true,
  }),
  mumu: unit({
...
abilityDescription: "施法距离内有友军陷入场地控制、持续压制、普通硬控或生命低于 35% 时，用舞带将最危险的一人拉到自己身后。落地后打断压制、净化普通控制，并治疗和添加护盾；时停只能通过被拉出范围解除。",
    portrait: "/images/livers/mumu.webp",
portraitFocus: "top",
shop: true,
  }),
  yukisyo: unit({
...
abilityDescription: "初始能量较高。发动技能时，为施法距离内友军添加持续 4 秒、只吸收技能及其衍生伤害的技能护盾；护盾由固定值与目标最大生命值共同决定，重复获得时取较高值并刷新持续时间。",
    ...
    portrait: "/images/livers/yukisyo.png",
portraitFocus: "top",
shop: true,
  }),
  xuehui: unit({
...
abilityDescription: "近战挥斩周围敌人并附加灼烧。己方越优势，自身攻速与射程最多降低 20%（骄兵必败）；越劣势，自身攻速与射程最多提高 50%，其余友军攻速最多提高 25%（哀兵必胜）。移速始终不受影响。",
    portrait: "/images/livers/xuehui.jpg",
portraitFocus: "top",
shop: true,
  }),
  rei: unit({
...
abilityDescription: "开场拥有 25 点能量，之后仅随时间缓慢回复，攻击与受击均不回能。施法范围内出现当前星级所需的 2/3/5 具尚未被复活的尸体后，将他们以四分之一血幽灵形态复活并加入己方；每具尸体只能复活一次。",
    ...
    portrait: "/images/livers/rei.jpg",
portraitFocus: "top",
shop: true,
  }),
  rutice: unit({
...
abilityDescription: "为施法距离内友军回复生命，并为其中生命比例最低的两名友军提供护盾。",
    portrait: "/images/livers/rutice.jpg",
portraitFocus: "top",
shop: true,
  }),
  lian: unit({
...
abilityDescription: "向受伤友军最密集的区域扔出一条天使鱼；落地治疗范围内友军，并留下持续 3.2 秒的治疗区。治疗量随帕可自身属性成长。",
    portrait: "/images/livers/pako.jpg",
portraitFocus: "top",
shop: true,
  }),
