...
> = {
  ...
  dawn_duelist: { attackType: "melee", energyProfile: HAREI_TRICK_ENERGY_PROFILE, range: 52, moveSpeed: 64, abilityCastTiming: "offenseInRange" },
...
export const UNIT_DEFS: Record<UnitId, UnitDefinition> = {
  ...
  dawn_duelist: unit({
    ...
    moveSpeed: 64,
    abilityName: "迎客松·大吧唧",
    abilityDescription: "开战时更快积攒第一句怪话；贴近敌人后随机使出迎客松或 75mm 大吧唧。迎客松短暂嘲讽附近敌人、降低 20% 移速，并按嘲讽人数获得护盾；大吧唧造成范围伤害与短暂眩晕。",
