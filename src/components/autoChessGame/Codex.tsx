      ...
      <main style={{ flex: 1, overflow: "auto", padding: 18 }}>
        ...
        {tab === "rules" && (
          <section style={{ maxWidth: 820, lineHeight: 1.9 }}>
            <h2>远征与无限裂隙</h2>
            <p>守住前 16 战即完成远征；第 4、8、12 战是精英关，第 16 战是终局首领，备战阶段会提前显示醒目的预警。第 17—31 战为普通无限，敌军按 5 利息、连胜和上一战击杀赏金全部复投；第 32 战起进入地狱无限，改按 20 利息、理财固定收入、连胜与赏金全部复投。敌军会组成并激活羁绊，预算优先转化为人口和升星，满编满星后才转化为额外属性。</p>
            <h2>操作</h2>
            ...
            <h2>经济</h2>
            <p>没有固定工资：每击败一名敌人，按其星级获得赏金，1/2/3 星分别提供 1/2/3 金。即使战斗失利，已击败敌人的赏金也会正常结算。每 5 金提供 1 利息，最多计算 20 金，即最高 4 利息；理财Ⅱ改为每 4 金提供 1 利息，最多 20 利息，需要存到 80 金。连胜和理财还能提供额外收入。升本是“支付当前剩余费用直接升级”；每回合的自然减费最低可将费用降至 0，溢出减费会结转到后续本级。最高 10 本可上阵 10 人。</p>
          </section>
        )}
      </main>
    </div>
