      ...
      <main style={{ flex: 1, overflow: "auto", padding: 18 }}>
        ...
        {tab === "rules" && (
          <section style={{ maxWidth: 820, lineHeight: 1.9 }}>
            <h2>远征与无限裂隙</h2>
            <p>守住前 25 战即完成远征；第 5、10、15、20 战是精英关，第 25 战是终局首领，备战阶段会提前显示醒目的预警。第 26—40 战为普通无限，敌军按 5 利息、连胜和上一战击杀赏金全部复投；第 41 战起进入地狱无限，改按 20 利息、理财固定收入、连胜与赏金全部复投。敌军预算会先转化为人口和升星，满编满星后才转化为额外属性。</p>
            <h2>操作</h2>
