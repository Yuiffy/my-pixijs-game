...
export const AUTOPILOT_STYLE_POLICIES: Record<CanonicalAutopilotStyle, Partial<AutopilotPolicy>> = {
  survival: {
    ...
    lateGamePurchaseStartRound: 10,
    lateGamePurchaseStartLevel: 7,
    terminalRollDownActivationGold: 124,
    terminalRollDownReserveGold: 44,
    terminalCompletionActivationGold: 104,
    terminalCompletionReserveGold: 24,
  ...
  highroll: {
    ...
    healthyStabilizeMaximumDryPaidRerolls: 8,
    healthyStabilizeRerollInterestTiersAtRisk: 3,
    financeActivationMaxRolloutDeficit: 100,
    financePurchaseInterestTiersAtRisk: 2,
    bankPurchaseInterestTiersAtRisk: 1,
    goodPurchaseInterestTiersAtRisk: 3,
    mergePurchaseInterestTiersAtRisk: 5,
    levelInterestTiersAtRisk: 3,
